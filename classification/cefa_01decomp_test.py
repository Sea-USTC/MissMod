...
sys.path.append('..')
from models.surf_baseline import SURF_01decomp, SURF_Hemis
...
from configuration.cefa_01decomp_multi import args
import torch
...
if __name__ == '__main__':
    ...
    # for k in range(0,3):
    #     pretrain_dir = "/remote-home/mengxichen/MMANet-CVPR2023-main/output/models/cefa_full__"+str(k)+"__unaverage_acer_best_.pth"
    #     print(pretrain_dir)
    #     args.modal = 'multi'
    #     args.miss_modal = 0
    #     args.p=[1,1,1]
    ...
    pretrain_dir = "/DB/public/siyili/lora/output/models/resnet_01decomp_0__average_acer_best_.pth"
    print(pretrain_dir)
    args.gpu = 0
    args.modal = 'multi'
    args.miss_modal = 0
    args.backbone = "resnet_01decomp"
    ...
    for j in range(len(modality_combination)):
        ...
        print(args.p)
        model = SURF_01decomp(args)
        # args.inplace_new = 256
        # model = SURF_Hemis(args)
