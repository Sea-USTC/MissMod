...
sys.path.append('..')
from models.surf_baseline import SURF_Baseline, SURF_Multi, SURF_MV, SURF_UNCLLateNet, SURF_MD, SURF_MMANet, SURF_ETMCNet, SURF_RAMLNet
...
if __name__ == '__main__':
    ...
    pretrain_dir1 = "/DB/public/mengxichen/code/mengxichen/MMANet-CVPR2023-main/output-1/models/surf_cat-2fc(0.5)-2_version_10_kd_0.0_shared_0.0_acer_best_.pth"
    args.gpu = 0
    args.modal = 'uni'
    ...
    for j in range(len(modality_combination)):
        ...
        try:
            model.load_state_dict(torch.load(pretrain_dir1))#['model_state']
            print(pretrain_dir1)
            model.avg = False
