...
sys.path.append('..')
from models.surf_baseline import SURF_Baseline, SURF_Multi, SURF_MV, SURF_01decomp
...
if __name__ == '__main__':
    ...
    from configuration.config_01decomp_multi import args
    ...
    pretrain_dir = "/DB/public/siyili/lora/classification/output/models/resnet_01decomp_3__average_acer_best_.pth"
    print(pretrain_dir)
    args.gpu = 0
    args.modal = 'multi'
    args.miss_modal = 0
