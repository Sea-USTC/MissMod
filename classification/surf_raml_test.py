...
sys.path.append('..')
from models.surf_baseline import SURF_Baseline, SURF_Multi, SURF_MV, SURF_RAMLNet
...
if __name__ == '__main__':
    ...
    pretrain_dir1 = "/DB/data/mengxichen/MMANet-CVPR2023-main/output/models/surf_raml_version_" + str(0) + "_uni_2.0_inf_2.0.pth"
    args.gpu = 0
    args.modal = 'uni'
    args.miss_modal = 0
