...
sys.path.append('..')
from models.surf_baseline import SURF_trmlora, SURF_Multi, SURF_MV
...
if __name__ == '__main__':
    ...
    pretrain_dir = "/DB/public/siyili/lora/classification/output/models/resnet_trm_1__average_acer_best_.pth"
    print(pretrain_dir)
    args.gpu = 0
    args.modal = 'multi'
    args.miss_modal = 0
