...
#         if args.modal == 'multi' and args.network == 'teacher':
...
#                                            dilate=replace_stride_with_dilation[1])
#         if args.modal == 'multi' and args.network == 'student':
#             self.inplanes = args.inplace_new * 2
#             self.layer4_new = self._make_layer(block, 512, layers[3], stride=2,
