...
sys.path.append('..')
from models.surf_baseline import SURF_Baseline, SURF_ETMCNet
...
if __name__ == '__main__':
    ...
    for i in [0.2,0.3,0.4]:
            ...
            result_list = []
            pretrain_dir = "/DB/public/mengxichen/code/mengxichen/MMANet-CVPR2023-main/output-miss/models/cefa_etmc_train_missing-" + str(i) + "_version_10_kd_0.2_acer_best_.pth"
            log_dir = "/DB/public/mengxichen/code/mengxichen/MMANet-CVPR2023-main/output-miss/logs/cefa_etmc_train_missing-"+ str(i) +"_version_10_kd_0.2.csv"
            args.gpu = 0
            args.modal = 'uni'
