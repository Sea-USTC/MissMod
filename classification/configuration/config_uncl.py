...
parser.add_argument('--train_epoch', type=int, default=110)
...
parser.add_argument('--save_interval', type=int, default=60, help='How many batches to save the model once')
parser.add_argument('--model_root', type=str, default='/DB/public/mengxichen/code/mengxichen/MMANet-CVPR2023-main/output-1/models')
parser.add_argument('--log_root', type=str, default='/DB/public/mengxichen/code/mengxichen/MMANet-CVPR2023-main/output-1/logs')
...
parser.add_argument('--T', type=float, default=0.1, help='temperature for ST')
...
parser.add_argument('--data_root', type=str,
                    default='/DB/public/mengxichen/CASIA-SURF')#/remote-home/share/mengxichen/CASIA-CeFA/CeFA-Race/CeFA-Race/
parser.add_argument('--method', type=str, default='uncl(neg-full)_cat-logp(0.1)_div-sum-64-drop-mean-23-7-110')
parser.add_argument('--gpu', type=int, default=2)
parser.add_argument('--version', type=int, default=2)
parser.add_argument('--seed', type=int, default=3407) #
parser.add_argument('--lambda_kd_shared', type=float, default=1.8, help='trade-off parameter for kd loss')
parser.add_argument('--lambda_kd_feature', type=float, default=1.8, help='trade-off parameter for kd loss')



args = parser.parse_args()
args.name = args.dataset + "_" + args.method + '_version_' + str(args.version) + '_kd_' + str(
    args.lambda_kd_feature) + '_shared_' + str(args.lambda_kd_shared) 
