...
parser.add_argument('--method', type=str, default='raml')
parser.add_argument('--gpu', type=int, default=3)
parser.add_argument('--version', type=int, default=1)
parser.add_argument('--weight_uni', type=float, default=0.8, help='trade-off parameter for kd loss')
parser.add_argument('--weight_inf', type=float, default=0.8, help='trade-off parameter for kd loss')

args = parser.parse_args()
args.name = args.dataset + "_" + args.method + '_version_' + str(args.version) + '_uni_' + str(
    args.weight_uni) +  '_inf_' + str(args.weight_inf)
