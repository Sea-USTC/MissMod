...
parser.add_argument('--model_root', type=str, default='/DB/public/mengxichen/code/mengxichen/MMANet-CVPR2023-main/output/models')
parser.add_argument('--log_root', type=str, default='/DB/public/mengxichen/code/mengxichen/MMANet-CVPR2023-main/output/logs')
...
parser.add_argument('--data_root', type=str,
                    default='/remote-home/share/mengxichen/CASIA-CeFA/CeFA-Race/CeFA-Race')
parser.add_argument('--method', type=str, default='mad_auxi_weak_auxi')
parser.add_argument('--gpu', type=int, default=0)
parser.add_argument('--version', type=int, default=0)
parser.add_argument('--lambda_kd_feature', type=float, default=30.0, help='trade-off parameter for kd loss')
parser.add_argument('--lambda_kd_mar', type=float, default=0.5, help='trade-off parameter for kd loss')
