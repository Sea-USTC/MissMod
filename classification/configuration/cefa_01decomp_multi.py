...
parser.add_argument('--lr_warmup', type=bool, default=0)
...
parser.add_argument('--gate01', type= float, default= 0.2)
...
parser.add_argument('--model_root', type=str, default='/DB/public/siyili/lora/output/models')
parser.add_argument('--log_root', type=str, default='/DB/public/siyili/lora/output/logs')
...
parser.add_argument('--data_root', type=str,
                    default='/DB/public/mengxichen/CASIA-CeFA/CeFA-Race/CeFA-Race')
