...
from models.surf_baseline import SURF_Multi, SURF_UNCLNet, SURF_UNCLLateNet, SURF_UNCLBaseline
from loss.kd import *
from lib.model_develop import train_uncl_patch_feature_teache_pre
...
def deeppix_main(args):
    ...
    args.modal = 'uni'
    student_model = SURF_UNCLLateNet(args)
    teacher_model = SURF_UNCLLateNet(args)

    teacher_model.load_state_dict(
            torch.load('/remote-home/mengxichen/MMANet-CVPR2023-main/output/models/cefa_uncl(neg-full)_cat-logp(0.1)_div-sum-64-drop-mean-23-7-110_version_1_kd_0.0_shared_0.0_acer_best_.pth'))
    ...
    train_uncl_patch_feature_teache_pre(net_dict=nets, cost_dict=criterions, optimizer=optimizer,
