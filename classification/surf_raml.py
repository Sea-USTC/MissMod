...
from models.surf_baseline import SURF_RAMLNet
from lib.model_develop import train_RAML
from configuration.config_raml import args
...
def deeppix_main(args):
    ...
    # seed_torch(5)
    student_model = SURF_RAMLNet(args)
    ...
    train_RAML(model= student_model, optimizer=optimizer, 
